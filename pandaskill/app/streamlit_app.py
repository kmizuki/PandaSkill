...
def run():
    ...
    st.divider()
    st.markdown(
        "This app is open-source under the [MIT License](https://github.com/PandaScore/PandaSkill/blob/main/LICENSE)."
    )
    st.markdown(
        "Interested in building projects with esports data? Check out the [PandaScore API](https://developers.pandascore.co/docs/introduction)!"
    )
