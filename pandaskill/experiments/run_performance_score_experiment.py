...
from pandaskill.experiments.performance_score.training_testing_cv import (
    compute_performance_scores_cv_loop,
)
...
if __name__ == "__main__":
    ...
    experiment_dir = join(
        ARTIFACTS_DIR, "experiments", config["experiment_name"], "performance_score"
    )
    ...
    data = load_data(load_features=True, drop_na=True)

    logging.info("Computing performance scores...")
    ...
    with open(join(experiment_dir, "performance_scores_metrics.yaml"), "w") as file:
