...
performance_scores_experiment_folder = join(
    ARTIFACTS_DIR, "experiments", performance_score_experiment
)
performance_scores = pd.read_csv(
    join(
        performance_scores_experiment_folder,
        "performance_score",
...
df_game = df_game.loc[
    :, ["player_name", "team_name", "role", "performance_score", "rating", "update"]
]
